...
excerpt: While out on a lark a few months ago, we bumped into a vestige of the colonial history of The Netherlands in Amsterdam. A grand tour through history, engineering, and the history of engineering ensued. Read on to meet compressed catenaries, colonial fanclubs, stiff slabs, and Pope Benedict XIV.
