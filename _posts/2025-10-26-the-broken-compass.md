...
## Data & analysis
I've uploaded [the notebook](/assets/posts/the-broken-compass/new_axes.ipynb) that I've used for the analysis and for generating the figures. Refer to the [parent folder](/assets/posts/the-broken-compass){:target="_blank"} for the data from the Choose Compass.
